    ...
    <div className="dark flex min-h-screen flex-1 flex-col bg-background text-foreground">
      <header className="sticky top-0 z-40 border-b border-border bg-background">
        <div className="mx-auto flex max-w-lg items-center justify-between px-4 py-3">
          ...
          <Link href="/barbeiro/dashboard" className="flex items-center gap-2">
          ...
          <SheetHeader className="border-b border-border p-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-primary">{isAdmin ? "Administrador" : "Barbeiro"}</p>
              </div>
            </div>
          </SheetHeader>
          ...
          <div className="flex flex-col gap-4 p-3">
            <form action={logoutAction}>
              <Button
                type="submit"
                variant="ghost"
                className="w-full justify-start gap-3 px-3 text-foreground/80"
              >
